package behavior.behaviordemo.widget.reveal;
...
//          startRadius, endRadius);
      return createCircularReveal(view,centerX,centerY,startRadius,endRadius,true);
    }
  ...
  @TargetApi(21)
  private static Animator createCircularReveal(View view, int centerX, int centerY, float startRadius, float endRadius,boolean nouse){
    return android.view.ViewAnimationUtils.createCircularReveal(view, centerX, centerY,
            startRadius, endRadius);
  }
